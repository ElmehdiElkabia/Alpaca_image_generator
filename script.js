    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            if (
                ...
                imgSrc.src = `assets/alpaca/hair/${ele.target.value}.png`;
            }
        });
    });
}
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            if (
                ...
                imgSrc.src = `assets/alpaca/accessories/${ele.target.value}.png`;
...
function handleBackground() {
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            ...
            if (cnt >= 1) {
                imgSrc.src = `assets/alpaca/backgrounds/${ele.target.value}.png`;
            }
        });
    });
}
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            ...
            if (
                ...
                imgSrc.src = `assets/alpaca/ears/${ele.target.value}.png`;
            }
        });
    });
}
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            ...
            if  (
                ...
                imgSrc.src = `assets/alpaca/eyes/${ele.target.value}.png`;
            }
        });
    });
}
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            ...
            if (
                ...
                imgSrc.src = `assets/alpaca/leg/${ele.target.value}.png`;
            }
        });
    });
}
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            ...
            if (
                ...
                imgSrc.src = `assets/alpaca/neck/${ele.target.value}.png`;
            }
        });
    });
}
    ...
    Array.from(BtnArray).forEach((e) => {
        e.addEventListener("click", (ele) => {
            ...
            if (
                ...
                imgSrc.src = `assets/alpaca/mouth/${ele.target.value}.png`;
            }
        });
    });
}
...
function handleAction(e) {
    ...
    if (actionToTakePlace == "random") {
        ...
        hair.src = `assets/alpaca/hair/${hairBtn[hairNumber].value}.png`;

        const acceNumber = Math.floor(Math.random() * acceBtn.length-1);
        acce.src = `assets/alpaca/accessories/${acceBtn[acceNumber].value}.png`;

        const backgroundNumber = Math.floor(Math.random() * backgroundBtn.length-1);
        background.src = `assets/alpaca/backgrounds/${backgroundBtn[backgroundNumber].value}.png`;

        const earsNumber = Math.floor(Math.random() * earBtn.length-1);
        ears.src = `assets/alpaca/ears/${earBtn[earsNumber].value}.png`;

        const eyesNumber = Math.floor(Math.random() * eyesBtn.length-1);
        eyes.src = `assets/alpaca/eyes/${eyesBtn[eyesNumber].value}.png`;

        const legNumber = Math.floor(Math.random() * legBtn.length-1);
        leg.src = `assets/alpaca/leg/${legBtn[legNumber].value}.png`;

        const mouthNumber = Math.floor(Math.random() * mouthBtn.length-1);
        mouth.src = `assets/alpaca/mouth/${mouthBtn[mouthNumber].value}.png`;
